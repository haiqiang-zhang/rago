"""
Run performance evaluateion of simple RAG.

Dataflow: Retrieval -> LLM Prefill -> LLM Decode

User can config the parameters at the beginning of this file to specify the runs.
"""
...
save_plot = True
save_path_all_points = "./img/example_case_1_all.png"  # Path to save the plot
save_path_pareto = "./img/example_case_1_pareto.png"  # Path to save the plot
save_path_breakdown = (
    "./img/example_case_1_workload_breakdown.png"  # Path to save the plot
)
